        ...
        <div className="flex flex-wrap justify-between gap-[20px] ">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 mb-6 mx-auto">
            ...
            <p className="text-gray-700">
              Zamaxshariy Edu - Arab tili o'rganish uchun onlayn ta'lim
              platformasi.
            </p>
          </div>
          {/* Aloqa ma'lumotlari */}
          <div className="w-full mx-auto flex flex-col gap-4 sm:w-1/2 lg:w-1/4 mb-6">
            ...
            <a
              href="https://t.me/zamaxshariyEduuz"
            ...
            >
              Email: hikmatullohabdullayev2@gmail.com
            </a>
          </div>
          {/* Tezkor havolalar */}
